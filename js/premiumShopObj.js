var premiumBundles = {
	...
	"Colors of Nature Bundle": {
		...
		"contentsString": "{{name|Percy}}\n{{name|Pug Treats Carousel}}\n{{name|Natural Wooden Pergola}}\n{{name|Natural Wooden Pergola Pond}}\n{{name|Natural Wooden Pergola Post}}\n{{name|Natural Wooden Pergola Corner Post}}\n{{name|Natural Wooden Pergola Side}}\n{{name|Swirling Leaves}}\n{{name|Swirling Forest Leaves}}\n{{name|Colors of Nature Well}}\n{{name|Colors of Nature Stall}}",
	...
	"Natural Pergola Set": {
		...
		"contentsString": "{{name|Natural Wooden Pergola Pond}}\n{{name|Natural Wooden Pergola}}\n{{name|Natural Wooden Pergola Corner Post}}\n{{name|Natural Wooden Pergola Post}}\n{{name|Natural Wooden Pergola Side}}",
		"priceString": "{{price|2000|moonstone}}"
	},
	"Swirling Leaves Set": {
		"linked_name": "Swirling Leaves Set",
		"contentsString": "{{name|Swirling Leaves}}\n{{name|Swirling Forest Leaves}}",
		"priceString": "{{price|1250|moonstone}}"
	},
	"Brick Garden Set": {
		"linked_name": "Brick Garden Set",
		"contentsString": "{{name|Brick Garden Entrance}}\n{{name|Brick Garden Planter Box}}\n{{name|Brick Garden Planter}}\n{{name|Brick Garden L-Shape}}\n{{name|Brick Garden Wall}}\n{{name|Brick Garden Block}}\n{{name|Brick Garden Corner}}\n{{name|Brick Garden Lamp}}\n{{name|Embellished Brick Garden Lamp}}",
		"priceString": "{{price|2000|moonstone}}"
	},
	"Sunflower Ensemble": {
